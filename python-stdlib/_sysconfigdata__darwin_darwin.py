...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGURE_CFLAGS': '-isysroot '
                     '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk',
 'CONFIGURE_CFLAGS_NODIST': '-I/opt/homebrew/include -flto -std=c11 -Wextra '
 ...
 'CONFIG_ARGS': "'--prefix=/opt/homebrew/opt/python@3.11' "
                "'--enable-ipv6' "
                "'--datarootdir=/opt/homebrew/opt/python@3.11/share' "
                "'--datadir=/opt/homebrew/opt/python@3.11/share' "
                "'--without-ensurepip' '--enable-loadable-sqlite-extensions' "
                "'--with-openssl=/opt/homebrew/opt/openssl@3' "
                "'--enable-optimizations' '--with-system-expat' "
                "'--with-system-libmpdec' '--with-readline=editline' "
                "'--with-lto' "
                "'--enable-framework=/opt/homebrew/opt/python@3.11/Frameworks' "
                "'--with-dtrace' '--with-dbmliborder=ndbm' "
                "'MACOSX_DEPLOYMENT_TARGET=15' 'CFLAGS=-isysroot "
                "/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk' "
                "'CFLAGS_NODIST=-I/opt/homebrew/include' 'LDFLAGS=-isysroot "
                "/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk' "
                "'LDFLAGS_NODIST=-L/opt/homebrew/lib "
                "-Wl,-rpath,/opt/homebrew/lib' "
                "'CPPFLAGS=-I/opt/homebrew/include' "
                "'py_cv_module__tkinter=disabled' "
                "'PKG_CONFIG_PATH=/opt/homebrew/opt/pkgconf/lib/pkgconfig:/opt/homebrew/opt/mpdecimal/lib/pkgconfig:/opt/homebrew/opt/openssl@3/lib/pkgconfig:/opt/homebrew/opt/readline/lib/pkgconfig:/opt/homebrew/opt/sqlite/lib/pkgconfig:/opt/homebrew/opt/xz/lib/pkgconfig' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13/lcov-report',
 ...
 'DESTDIRS': '/opt/homebrew/opt/python@3.11/Frameworks/Python.framework/Versions/3.11 '
             '/opt/homebrew/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib '
             '/opt/homebrew/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11 '
             '/opt/homebrew/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/lib/python3.11/lib-dynload',
 ...
 'INCLDIRSTOMAKE': '/opt/homebrew/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include '
                   '/opt/homebrew/opt/python@3.11/Frameworks/Python.framework/Versions/3.11/include '
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -Wunreachable-code -fno-common -dynamic '
                    '-DNDEBUG -g -fwrapv -O3 -Wall -isysroot '
                    '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk '
                    '-I/opt/homebrew/include -flto -std=c11 -Wextra '
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -Wsign-compare '
                    '-Wunreachable-code -fno-common -dynamic -DNDEBUG -g '
                    '-fwrapv -O3 -Wall -isysroot '
                    '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk '
                    '-I/opt/homebrew/include -flto -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
 ...
 'MODULE__LZMA_CFLAGS': '-I/opt/homebrew/Cellar/xz/5.8.1/include',
 'MODULE__LZMA_LDFLAGS': '-L/opt/homebrew/Cellar/xz/5.8.1/lib -llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/opt/homebrew/opt/sqlite/include '
                           '-I./Modules/_sqlite',
 ...
 'PY_CFLAGS': '-Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG '
              ...
              '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk',
 'PY_CFLAGS_NODIST': '-I/opt/homebrew/include -flto -std=c11 -Wextra '
                     '-Wno-unused-parameter -Wno-missing-field-initializers '
                     '-Wstrict-prototypes '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden -fprofile-instr-use=code.profclangd '
 ...
 'PY_CORE_LDFLAGS': '-isysroot '
                    '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk '
                    '-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib -flto '
                    '-Wl,-export_dynamic -g',
 ...
 'PY_LDFLAGS': '-isysroot '
               '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk',
 'PY_LDFLAGS_NODIST': '-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib -flto '
                      '-Wl,-export_dynamic -g',
 'PY_LDFLAGS_NOLTO': '-isysroot '
                     '/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk '
                     '-flto=thin',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13 '
               './python.exe -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13 '
               './python.exe -E ./Tools/scripts/run_tests.py',
 ...
 'abs_builddir': '/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13',
 'abs_srcdir': '/private/tmp/pythonA3.11-20250604-6985-acyfvh/Python-3.11.13',
 'datarootdir': '/opt/homebrew/opt/python@3.11/share',
